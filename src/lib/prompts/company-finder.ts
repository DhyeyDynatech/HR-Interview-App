...
For each UNIQUE company extracted above, search the web and determine whether this company has ANY connection to **Microsoft Dynamics 365**, **SAP**, or **Microsoft ecosystem** (Azure, Power Platform, Microsoft 365, etc.).

Set **isRelevant** to true if ANY of the following is true:
- It is an IT firm/consultancy that implements or provides services in Microsoft Dynamics 365, SAP, or Microsoft technologies for clients
- It is a Microsoft Partner (Gold/Silver/Solutions Partner)
- It is a SAP Partner or SAP service provider
- It is an end-user organization (bank, manufacturer, retailer, etc.) that uses Microsoft Dynamics 365 or SAP internally
- There is any credible web evidence linking this company to Dynamics 365, SAP, or Microsoft Partner ecosystem

Set **isRelevant** to false only if web search finds NO connection to Dynamics 365, SAP, or Microsoft Partner ecosystem.
...
- **isRelevant**: true if the company has ANY connection to Microsoft Dynamics 365, SAP, or Microsoft ecosystem (Azure, Power Platform, Microsoft 365, etc.). false otherwise.
