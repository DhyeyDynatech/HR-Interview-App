export interface ViolationEvent {
  type: 'tab_switch' | 'face_mismatch' | 'camera_off' | 'multiple_person';
  timestamp: string;
  details?: string;
}
...
export interface Response {
  ...
  multiple_person_count?: number;
  face_mismatch_total?: number;
  camera_off_total?: number;
  multiple_person_total?: number;
  violations_summary?: ViolationEvent[];
}
